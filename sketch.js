// created BY AADI GOLECHA ON EIGHT AUGUST
//EPIC ARCHER FINAL GAME
...
function draw() 
{
  ...
  computerArcher.body.position.x = computer.body.position.x-70;
  playerArcher.body.position.x = player.body.position.x+55;
...
function handlePlayerArrowCollision() 
{
  ...
  for (var i = 0; i < playerArrows.length; i++) {
    ...
    if (
     ...
     console.log("PlayerArrow Collided computer")
  ...
  swal(
    {
      ...
      imageUrl:
        "https://www.linkpicture.com/q/gameOver.jpg",
      imageSize: "150x150",
